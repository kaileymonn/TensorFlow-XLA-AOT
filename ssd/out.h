...
// Preprocessor represents a computation previously specified in a
...
//   (arg0: s32[1,300,300,3]) -> (f32[1,300,300,3], s32[1,3])
//
// Memory stats:
//   arg bytes total:    1080000
//   arg bytes aligned:  1080000
//   temp bytes total:   1080028
//   temp bytes aligned: 1080128
class Preprocessor : public tensorflow::XlaCompiledCpuFunction {
 public:
  ...
  static const intptr_t* ArgSizes() {
    static constexpr intptr_t kArgSizes[kNumArgs] = {1080000};
    return kArgSizes;
  }
  ...
  Preprocessor(AllocMode alloc_mode = AllocMode::ARGS_RESULTS_PROFILES_AND_TEMPS)
  ...
  tensorflow::int32* arg0_data() {
    return static_cast<tensorflow::int32*>(arg_data(0));
  }
  tensorflow::int32& arg0(size_t dim0, size_t dim1, size_t dim2, size_t dim3) {
    return (*static_cast<tensorflow::int32(*)[1][300][300][3]>(
        arg_data(0)))[dim0][dim1][dim2][dim3];
  }
  const tensorflow::int32* arg0_data() const {
    return static_cast<const tensorflow::int32*>(arg_data(0));
  }
  const tensorflow::int32& arg0(size_t dim0, size_t dim1, size_t dim2, size_t dim3) const {
    return (*static_cast<const tensorflow::int32(*)[1][300][300][3]>(
        arg_data(0)))[dim0][dim1][dim2][dim3];
  }
  ...
  float& result0(size_t dim0, size_t dim1, size_t dim2, size_t dim3) {
    return (*static_cast<float(*)[1][300][300][3]>(
        result_data(0)))[dim0][dim1][dim2][dim3];
  }
  const float* result0_data() const {
    return static_cast<const float*>(result_data(0));
  }
  const float& result0(size_t dim0, size_t dim1, size_t dim2, size_t dim3) const {
    return (*static_cast<const float(*)[1][300][300][3]>(
        result_data(0)))[dim0][dim1][dim2][dim3];
  }

  tensorflow::int32* result1_data() {
    return static_cast<tensorflow::int32*>(result_data(1));
  }
  tensorflow::int32& result1(size_t dim0, size_t dim1) {
    return (*static_cast<tensorflow::int32(*)[1][3]>(
        result_data(1)))[dim0][dim1];
  }
  const tensorflow::int32* result1_data() const {
    return static_cast<const tensorflow::int32*>(result_data(1));
  }
  const tensorflow::int32& result1(size_t dim0, size_t dim1) const {
    return (*static_cast<const tensorflow::int32(*)[1][3]>(
        result_data(1)))[dim0][dim1];
  }

 private:
  // Number of result and temporary buffers for the compiled computation.
  static constexpr size_t kNumTemps = 5;
  ...
  static const intptr_t* TempSizes() {
    static constexpr intptr_t kTempSizes[kNumTemps] = {1080000, -1, 16, 12, -1};
    return kTempSizes;
  }
